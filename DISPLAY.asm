;Macro alterada para funcionar en el juego
;Macros para LED

DISPLAY MACRO
        LOCAL COLOR2,AZUL,VERDE,CIAN,ROJO,MAGENTA,MARRON,CELESTE,AMARILLO,BLANCO,SEGUIR,CHECK_MOUSE_BOTTONS,VOLVERINICIO,TERMINAR,CAMBIACOLOR,VOLVERAZUL
